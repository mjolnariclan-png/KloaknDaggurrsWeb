-- ============================================================
-- COMPLETE DATABASE SETUP - KLOAK & DAGGURRS
-- ============================================================
-- This script combines all database setup for the project
-- Run this ONCE to set up the complete database structure
-- ============================================================

-- ============================================================
-- DELETE ALL EXISTING DATA (RESET)
-- ============================================================
...
-- Insert factions with Tome/Book system and rune images
